...
await mkdir(`${root}/.obsidian/plugins/superpowers`, { recursive: true });
const plugin = `${root}/.obsidian/plugins/superpowers`;
...
await Bun.write(`${root}/.obsidian/community-plugins.json`, JSON.stringify(['superpowers']));
